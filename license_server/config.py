...
def get_smtp_host() -> str:
    ...
    return os.environ.get("CMDF_SMTP_HOST", "smtp.gmail.com")


def get_smtp_port() -> int:
    """Return SMTP port."""
    return int(os.environ.get("CMDF_SMTP_PORT", "587"))


def get_smtp_user() -> str | None:
    """Return SMTP username."""
    return os.environ.get("CMDF_SMTP_USER")


def get_smtp_password() -> str | None:
    """Return SMTP password or app password."""
    return os.environ.get("CMDF_SMTP_PASSWORD")


def get_smtp_from() -> str:
    """Return the From: address for outbound email."""
    return os.environ.get("CMDF_SMTP_FROM", "noreply@claudemd-forge.dev")
