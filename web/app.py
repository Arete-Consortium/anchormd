...
async def push_pr(
    ...
    async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
        ...
        pr_body = (
            ...
            "(Claude Code, Cursor, Copilot, OpenCode) accurate context about your project.\n\n"
...
async def get_agents_md(scan_id: str) -> dict[str, Any]:
    ...
    AGENTS.md is the shared convention adopted by Cursor, OpenAI Codex, OpenCode, and
    other AI coding tools — a single tool-agnostic instructions file per repo.
    """
    import re
