...
under the `.claudemd/` directory tree.
"""
...
from claudemd_forge.drift.models import BenchmarkSuite, RunRecord
from claudemd_forge.exceptions import DriftError

logger = logging.getLogger(__name__)

_BENCHMARKS_DIR = ".claudemd/benchmarks"
_HISTORY_DIR = ".claudemd/drift/history"
_BASELINE_FILE = ".claudemd/drift/baseline.json"
_TREND_FILE = ".claudemd/drift/trend.json"
...
def load_benchmarks(root: Path) -> list[BenchmarkSuite]:
    """Load all benchmark suite YAML files from `.claudemd/benchmarks/`."""
